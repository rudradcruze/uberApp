...
import com.rudradcruze.project.uber.uberApp.repositories.RideRequestRepository;
import com.rudradcruze.project.uber.uberApp.repositories.RiderRepository;
...
public class RiderServiceImpl implements RiderService {
    ...
    public RideRequestDto requestRide(RideRequestDto rideRequestDto) {
        RideRequest rideRequest = modelMapper.map(rideRequestDto, com.rudradcruze.project.uber.uberApp.entities.RideRequest.class);
